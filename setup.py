...
def load_about():
    about = {}
    with io.open(
        os.path.join(HERE, "tutorgym_customizations", "__about__.py"),
        "rt",
        encoding="utf-8",
    ) as f:
...
setup(
    ...
    description="Customizing Gymnasium Open edX Instance",
    ...
    entry_points={
        "tutor.plugin.v1": [
            "gym-customizations = tutorgym_customizations.plugin"
        ]
    },
    classifiers=[
